...
visit04_1 |> 
  ggplot(aes(x=visit_bool_04_1)) + geom_histogram(binwidth = 0.5, fill = "#004080") + labs(title = "Distribution of visits per week, both types of non-coresidential fathers", x = "Visits per Week", y = "Count")
```
